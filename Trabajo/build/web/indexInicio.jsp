...
<%@page import="servicios.proyecto.ProyectoService"%>
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <% List<Proyecto> listProyecto = (List<Proyecto>) session.getAttribute("proyecto");
                
                for(int i=0;i<listProyecto.size();i++){
                    Proyecto p = listProyecto.get(i);
                    int id = p.getIdProyecto();
                    String nombre= p.getNombre();
                    Date fechaIniP = p.getFip();
                    Date fechaFinP= p.getFfp();
                    Date fechaIniR = p.getFir();
                    Date fechaFinR = p.getFfr();
